    ...
    <div className='instructions-main'>
      ...
      <div className='message'>
        ...
        <div className='message'>
          ...
          <span className='message-item'>The number of cells and loot in the hunting ground depends on the level. The level will increase by 1 every week (Max 6).</span>
        </div>
        <div className='message'>
